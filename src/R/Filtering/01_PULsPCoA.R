...
## Filter by Order
orders.arr <- c("Acidaminococcales","Bacteroidales","Betaproteobacteriales","Chitinophagales","Deinococcales","Enterobacterales","Erysipelotrichales","Flavobacteriales","Lachnospirales","Lactobacillales","Pseudomonadales","Veillonellales")
...
colvec<- c("#088F8F","#800020", "#E97451", "#C04000", "#7CFC00", "#8A2BE2","#FFD700","#FF6347", "#FF8C00")#, "#4169E1", "#7B68EE", "#D2691E", "#1E90FF", "#FF1493")
unique.df["Colvec"] <- colvec
